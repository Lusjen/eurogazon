...
jQuery(document).ready(function($) {
	...
	$('.slider-one__btn-prev').on('click', function(){
		$('.js-slider-one').slick('slickPrev');
	});

	$('.slider-one__btn-next').on('click', function(){
